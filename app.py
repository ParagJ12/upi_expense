...
<div class="bg-symbols">
  <span class="sym" style="font-size:180px;top:5%;left:3%;opacity:.025;">₹</span>
  <span class="sym" style="font-size:120px;top:60%;left:8%;opacity:.02;">$</span>
  <span class="sym" style="font-size:200px;top:20%;right:4%;opacity:.02;">₹</span>
  <span class="sym" style="font-size:90px;top:75%;right:10%;opacity:.025;">€</span>
  <span class="sym" style="font-size:150px;top:45%;left:45%;opacity:.015;">₹</span>
  <span class="sym" style="font-size:80px;top:15%;left:55%;opacity:.02;">%</span>
  <span class="sym" style="font-size:110px;top:82%;left:30%;opacity:.02;">$</span>
  <span class="sym" style="font-size:70px;top:35%;right:28%;opacity:.025;">₹</span>
</div>
...
if df is None:
    ...
    with c1:
        st.markdown(f"""<div class="kpi-card">
          ...
          <div class="kpi-sub">{len(spend)} debit transactions</div>
    ...
    with c4:
        st.markdown(f"""<div class="kpi-card">
          ...
          <div class="kpi-value" style="font-size:1.3rem;">{CAT_EMOJI.get(top_c,"")} {top_c}</div>
    ...
    with tab1:
        ...
        with col_l:
            ...
            fig.add_annotation(text=f"₹{total/1000:.1f}k", x=0.5, y=0.54, showarrow=False,
